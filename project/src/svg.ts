 ...
 */
  scorpio(x: number, y: number): Element {
    ...
    node.setAttribute('d', `M${x},${y}m9.6,4.9c0,0,-2.6,0.2,-3.8,-1.2s-0.8,-5.1,-0.7,-7.9c0.1,-2.7,-1.8,-2.7,-1.8,-2.7c-3.7,0,-4,10.1,-4,10.1h0c0,0,2.2,-10.1,-1.5,-10.1s-4,10.1,-4,10.1h0c0,0,2.2,-10.1,-1.5,-10.1c-0.8,0,-1.5,0.5,-2,1.4m17.2,12.4l2.1,-1.9l-1.9,-2.2`)
    node.setAttribute('stroke-linecap', 'round')
    node.setAttribute('stroke-linejoin', 'round')
